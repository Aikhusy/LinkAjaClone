                  ...
                  children: [
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(logoLeftMargin,
                          logoLeftMargin / 2, logoLeftMargin, 0),
                      child: Column(
                        children: [
                          Row(
                            children: [
              ...
              Row(
                children: [
                  Container(
                    ...
                    width: containerMaxWidth,
                    height: navbarDim + ((1 / 2) * navbarDim),
                    margin: EdgeInsets.fromLTRB(
                        logoLeftMargin, 0, logoLeftMargin, 0),
                    child: Column(
                      children: [
                        Row(
                          children: [
                            Container(
                              ...
                              height: logoDim,
                              margin:
                                  EdgeInsets.fromLTRB(logoLeftMargin, 0, 0, 0),
                              child: Column(
                                children: [
                                  Row(
                                    children: [
                                      Container(
                                        margin: EdgeInsets.fromLTRB(
                                            logoLeftMargin / 2, 0, 0, 0),
                                        width: navbarDim - navbarDim * 1 / 3,
                                        height: navbarDim - navbarDim * 1 / 3,
                                        child: Image.network(
                                          'https://cdn-icons-png.flaticon.com/512/5405/5405811.png',
                                          width: navbarDim - navbarDim * 1 / 3,
                                          height: navbarDim - navbarDim * 1 / 3,
                            ...
                            Container(
                              ...
                              height: logoDim,
                              margin:
                                  EdgeInsets.fromLTRB(0, 0, logoLeftMargin, 0),
                              child: Column(
                                children: [
                                  Row(
                                    children: [
